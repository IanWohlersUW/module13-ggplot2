...
# What do you see?
ggplot(data = diamonds.sample) #Don't see anything yet
...
ggplot(data = diamonds.sample) +
  geom_smooth(se = FALSE, mapping = aes(x = carat, y = price, color = carat))
